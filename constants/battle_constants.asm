...
; Mental effect flags for Farfetch'd → Madame evolution (wMentalEffectFlags)
	const MENTAL_F_CONFUSED
	const MENTAL_F_INFATUATED
	const MENTAL_F_DISABLED
	const MENTAL_F_INTIMIDATED
	const MENTAL_F_ENCORED
	const MENTAL_F_TAUNTED
	const MENTAL_F_TORMENTED
DEF MENTAL_F_CONFUSED_F     EQU 1 << MENTAL_F_CONFUSED
DEF MENTAL_F_INFATUATED_F   EQU 1 << MENTAL_F_INFATUATED
DEF MENTAL_F_DISABLED_F     EQU 1 << MENTAL_F_DISABLED
DEF MENTAL_F_INTIMIDATED_F  EQU 1 << MENTAL_F_INTIMIDATED
DEF MENTAL_F_ENCORED_F      EQU 1 << MENTAL_F_ENCORED
DEF MENTAL_F_TAUNTED_F      EQU 1 << MENTAL_F_TAUNTED
DEF MENTAL_F_TORMENTED_F    EQU 1 << MENTAL_F_TORMENTED
...
DEF HAZARDS_STEALTH_ROCK EQU %00000001
