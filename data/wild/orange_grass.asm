; Orange Pokémon in grass
	...
	wildmon LEVEL_FROM_BADGES + 4, PERSIAN
	wildmon LEVEL_FROM_BADGES + 2, PERSIAN
	; day
	wildmon LEVEL_FROM_BADGES - 1, RHYHORN
	wildmon LEVEL_FROM_BADGES - 1, GRAVELER
	wildmon LEVEL_FROM_BADGES + 1, MEOWTH, GALARIAN_FORM
	...
	; morn
	wildmon LEVEL_FROM_BADGES - 1, NOCTOWL
	wildmon LEVEL_FROM_BADGES - 1, LEDIAN
	wildmon LEVEL_FROM_BADGES + 1, ARBOK, ARBOK_ORANGE_FORM
	wildmon LEVEL_FROM_BADGES + 3, PAWNIARD
	wildmon LEVEL_FROM_BADGES + 2, WEEPINBELL
	wildmon LEVEL_FROM_BADGES + 4, NATU
	...
	wildmon LEVEL_FROM_BADGES + 2, HYPNO
	wildmon LEVEL_FROM_BADGES + 4, HYPNO
	wildmon LEVEL_FROM_BADGES + 6, HYPNO
	; day
	wildmon LEVEL_FROM_BADGES - 2, SEEL
	wildmon LEVEL_FROM_BADGES - 1, SEEL
	wildmon LEVEL_FROM_BADGES + 0, DEWGONG
