if DEF(FAITHFUL)
	bst 395,  65,  90,  40,  45,  80,  75
	;   bst   hp  atk  def  sat  sdf  spe
else
	bst 450,  65, 105,  50,  55,  90,  85
	;   bst   hp  atk  def  sat  sdf  spe
endc
